...
public class NQueen_listOutput {
...
//        }
        List<List<String>> result  =  nqueens(board, 0);
    ...
    public static List<List<String>> nqueens(boolean[][] board, int row){
        ...
        if(row == board.length ){
            ...
            list.add(printBoardStrinbBuilder(board, row));
            return list;
        }
    ...
    private static List<String> printBoard(boolean[][] board, int row) {
    ...
    private static List<String> printBoardStrinbBuilder(boolean[][] board, int row) {
